export function FieldTextarea({
  ...
  return (
    <div className="group">
      ...
      <div className="flex gap-3 border-b-2 border-stone-100 group-focus-within:border-primary transition-colors pb-2">
        <span className="text-stone-400 group-focus-within:text-primary transition-colors shrink-0 mt-1">
          {icon}
        </span>
